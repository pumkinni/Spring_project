...
class AccountControllerTest {
    ...
    @Autowired
    private ObjectMapper objectMapper; // object를 json으로 변환
    ...
    void successGetAccountByUserId() throws Exception {
        ...
        mockMvc.perform(get("/account?user_id=1"))
                ...
                .andExpect(jsonPath("$[1].accountNumber").value("7890123456"))
                .andExpect(jsonPath("$[1].balance").value(100L))
                .andExpect(jsonPath("$[2].accountNumber").value("4567890123"))
                .andExpect(jsonPath("$[2].balance").value(10000L));
    }
